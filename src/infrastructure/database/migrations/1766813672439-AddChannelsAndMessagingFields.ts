...
export class AddChannelsAndMessagingFields1766813672439 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "chronos" ADD "message_template" text`,
    );
    await queryRunner.query(`ALTER TABLE "chronos" ADD "recipients" jsonb`);
    await queryRunner.query(
      `ALTER TABLE "chronos" ADD CONSTRAINT "FK_21ac64648ff2fcbed75a56dec1d" FOREIGN KEY ("channel_id") REFERENCES "channels"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "chronos" DROP CONSTRAINT "FK_21ac64648ff2fcbed75a56dec1d"`,
    );
    await queryRunner.query(`ALTER TABLE "chronos" DROP COLUMN "recipients"`);
    await queryRunner.query(
      `ALTER TABLE "chronos" DROP COLUMN "message_template"`,
    );
