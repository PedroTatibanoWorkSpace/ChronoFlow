...
export class AddFunctions1767254178221 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "functions" ADD CONSTRAINT "FK_6dc8e49d59b2c17635558f76702" FOREIGN KEY ("channel_id") REFERENCES "channels"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "chronos" ADD CONSTRAINT "FK_c9b325f9fe19b889fb9162f5837" FOREIGN KEY ("function_id") REFERENCES "functions"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "chronos" DROP CONSTRAINT "FK_c9b325f9fe19b889fb9162f5837"`,
    );
    await queryRunner.query(
      `ALTER TABLE "functions" DROP CONSTRAINT "FK_6dc8e49d59b2c17635558f76702"`,
    );
